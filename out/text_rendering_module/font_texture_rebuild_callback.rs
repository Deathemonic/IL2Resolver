...
#[repr(transparent)]
#[derive(UnityClass)]
#[unity(assembly = "UnityEngine.TextRenderingModule", class = "FontTextureRebuildCallback", namespace = "UnityEngine", inherit = "MulticastDelegate,Delegate")]
pub struct FontTextureRebuildCallback(pub *mut c_void);

#[unity_impl]
impl FontTextureRebuildCallback {
    #[unity_ctor]
