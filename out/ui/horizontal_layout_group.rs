...
#[repr(transparent)]
#[derive(UnityClass)]
#[unity(assembly = "UnityEngine.UI", class = "HorizontalLayoutGroup", namespace = "UnityEngine.UI", inherit = "HorizontalOrVerticalLayoutGroup,LayoutGroup,UIBehaviour,MonoBehaviour,Behaviour,Component,Object")]
pub struct HorizontalLayoutGroup(pub *mut c_void);
