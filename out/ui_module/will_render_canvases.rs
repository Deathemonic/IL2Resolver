...
#[repr(transparent)]
#[derive(UnityClass)]
#[unity(assembly = "UnityEngine.UIModule", class = "WillRenderCanvases", namespace = "UnityEngine", inherit = "MulticastDelegate,Delegate")]
pub struct WillRenderCanvases(pub *mut c_void);

#[unity_impl]
impl WillRenderCanvases {
    #[unity_ctor]
