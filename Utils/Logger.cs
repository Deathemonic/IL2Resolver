...
public static class Log
{
    ...
    private static bool _suppressWarnings;
    ...
    private static void InitializeLogger(LogLevel minLevel)
    {
        ...
        _logger = _loggerFactory.CreateLogger("IL2Resolver");
        _isInitialized = true;
    }
    ...
    public static void SetSuppressWarnings(bool suppress) => _suppressWarnings = suppress;
